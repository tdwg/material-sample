# 2023-05-17 Material Sample Task Group Meeting Notes
## Participants
### 10AM MDT
Teresa Mayfield-Meyer, Roger Burkhalter, Stan Blum, Jutta Buchsbom, Stephen Richard.
### 4PM MDT
...
#### 10AM MDT
Let’s leave FossilSpecimen, LivingSpecimen, and PreservedSpecimen alone for now - this needs a new Task Group to develop a Material Extension with more descriptive terms and a semantic layer/ontology.  

Everyone will read through the package and add any comments to the issues for this afternoon.  
#### 4PM MDT
We had a lovely chat - let’s move this to public review!
