Issue - https://github.com/tdwg/material-sample/issues/45
...
* Definition of the term (normative): The full name of the lithostratigraphic bed from which the ~~cataloged item~~**MaterialEntity** was collected.
