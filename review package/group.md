Issue - https://github.com/tdwg/material-sample/issues/53
...
* Definition of the term (normative): The full name of the lithostratigraphic group from which the ~~cataloged item~~**MaterialEntity** was collected.
